  ...
  return (
    <div className="d-flex  justify-content-center align-items-center">
      <div className="w-50 bg-white rounded p-3">
        ...
        <Link to={'/users'} style={{color:'black', textDecoration:'none',fontWeight:'bold', fontSize:'20px', marginLeft:'550px'}}>X</Link>
          <h2 style={{color:'black'}} className='text-center mb-4'>Update User</h2>
          ...
          <Form.Group className="mb-3">
            <Form.Label style={{color:'black'}}>UserType</Form.Label>
            <div className="input-group">
              <Form.Control
                type="text"
          ...
          <Form.Group className="mb-3">
            <Form.Label style={{color:'black'}}>Account Activation</Form.Label>
            <div className="input-group">
              <Form.Control
                type="text"
